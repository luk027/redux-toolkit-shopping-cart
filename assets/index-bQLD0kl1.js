 ...
 *
 * @license MIT
 */var Ap="popstate";function Fv(t={}){function r(s,c){let{pathname:d="/",search:h="",hash:p=""}=ir(s.location.hash.substring(1));return!d.startsWith("/")&&!d.startsWith(".")&&(d="/"+d),Du("",{pathname:d,search:h,hash:p},c.state&&c.state.usr||null,c.state&&c.state.key||"default")}function i(s,c){let d=s.document.querySelector("base"),h="";if(d&&d.getAttribute("href")){let p=s.location.href,m=p.indexOf("#");h=m===-1?p:p.slice(0,m)}return h+"#"+(typeof c=="string"?c:Qo(c))}function a(s,c){Sn(s.pathname.charAt(0)==="/",`relative pathnames are not supported in hash history.push(${JSON.stringify(c)})`)}return qv(r,i,a,t)}function De(t,r){if(t===!1||t===null||typeof t>"u")throw new Error(r)}function Sn(t,r){if(!t){typeof console<"u"&&console.warn(r);try{throw new Error(r)}catch{}}}function $v(){return Math.random().toString(36).substring(2,10)}function Fp(t,r){return{usr:t.state,key:t.key,idx:r}}function Du(t,r,i=null,a){return{pathname:typeof t=="string"?t:t.pathname,search:"",hash:"",...typeof r=="string"?ir(r):r,state:i,key:r&&r.key||a||$v()}}function Qo({pathname:t="/",search:r="",hash:i=""}){return r&&r!=="?"&&(t+=r.charAt(0)==="?"?r:"?"+r),i&&i!=="#"&&(t+=i.charAt(0)==="#"?i:"#"+i),t}function ir(t){let r={};if(t){let i=t.indexOf("#");i>=0&&(r.hash=t.substring(i),t=t.substring(0,i));let a=t.indexOf("?");a>=0&&(r.search=t.substring(a),t=t.substring(0,a)),t&&(r.pathname=t)}return r}function qv(t,r,i,a={}){let{window:s=document.defaultView,v5Compat:c=!1}=a,d=s.history,h="POP",p=null,m=b();m==null&&(m=0,d.replaceState({...d.state,idx:m},""));function b(){return(d.state||{idx:null}).idx}function w(){h="POP";let k=b(),_=k==null?null:k-m;m=k,p&&p({action:h,location:v.location,delta:_})}function y(k,_){h="PUSH";let C=Du(v.location,k,_);i(C,k),m=b()+1;let O=Fp(C,m),P=v.createHref(C);try{d.pushState(O,"",P)}catch(D){if(D instanceof DOMException&&D.name==="DataCloneError")throw D;s.location.assign(P)}c&&p&&p({action:h,location:v.location,delta:1})}function E(k,_){h="REPLACE";let C=Du(v.location,k,_);i(C,k),m=b();let O=Fp(C,m),P=v.createHref(C);d.replaceState(O,"",P),c&&p&&p({action:h,location:v.location,delta:0})}function x(k){let _=s.location.origin!=="null"?s.location.origin:s.location.href,C=typeof k=="string"?k:Qo(k);return C=C.replace(/ $/,"%20"),De(_,`No window.location.(origin|href) available to create URL for href: ${C}`),new URL(C,_)}let v={get action(){return h},get location(){return t(s,d)},listen(k){if(p)throw new Error("A history only accepts one active listener");return s.addEventListener(Ap,w),p=k,()=>{s.removeEventListener(Ap,w),p=null}},createHref(k){return r(s,k)},createURL:x,encodeLocation(k){let _=x(k);return{pathname:_.pathname,search:_.search,hash:_.hash}},push:y,replace:E,go(k){return d.go(k)}};return v}function Zh(t,r,i="/"){return Uv(t,r,i,!1)}function Uv(t,r,i,a){let s=typeof r=="string"?ir(r):r,c=jt(s.pathname||"/",i);if(c==null)return null;let d=em(t);Bv(d);let h=null;for(let p=0;h==null&&p<d.length;++p){let m=e0(c);h=Jv(d[p],m,a)}return h}function em(t,r=[],i=[],a=""){let s=(c,d,h)=>{let p={relativePath:h===void 0?c.path||"":h,caseSensitive:c.caseSensitive===!0,childrenIndex:d,route:c};p.relativePath.startsWith("/")&&(De(p.relativePath.startsWith(a),`Absolute route path "${p.relativePath}" nested under path "${a}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),p.relativePath=p.relativePath.slice(a.length));let m=it([a,p.relativePath]),b=i.concat(p);c.children&&c.children.length>0&&(De(c.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${m}".`),em(c.children,r,b,m)),!(c.path==null&&!c.index)&&r.push({path:m,score:Yv(m,c.index),routesMeta:b})};return t.forEach((c,d)=>{var h;if(c.path===""||!((h=c.path)!=null&&h.includes("?")))s(c,d);else for(let p of nm(c.path))s(c,d,p)}),r}function nm(t){let r=t.split("/");if(r.length===0)return[];let[i,...a]=r,s=i.endsWith("?"),c=i.replace(/\?$/,"");if(a.length===0)return s?[c,""]:[c];let d=nm(a.join("/")),h=[];return h.push(...d.map(p=>p===""?c:[c,p].join("/"))),s&&h.push(...d),h.map(p=>t.startsWith("/")&&p===""?"/":p)}function Bv(t){t.sort((r,i)=>r.score!==i.score?i.score-r.score:Gv(r.routesMeta.map(a=>a.childrenIndex),i.routesMeta.map(a=>a.childrenIndex)))}var Hv=/^:[\w-]+$/,Wv=3,Qv=2,Vv=1,Kv=10,Xv=-2,$p=t=>t==="*";function Yv(t,r){let i=t.split("/"),a=i.length;return i.some($p)&&(a+=Xv),r&&(a+=Qv),i.filter(s=>!$p(s)).reduce((s,c)=>s+(Hv.test(c)?Wv:c===""?Vv:Kv),a)}function Gv(t,r){return t.length===r.length&&t.slice(0,-1).every((a,s)=>a===r[s])?t[t.length-1]-r[r.length-1]:0}function Jv(t,r,i=!1){let{routesMeta:a}=t,s={},c="/",d=[];for(let h=0;h<a.length;++h){let p=a[h],m=h===a.length-1,b=c==="/"?r:r.slice(c.length)||"/",w=Ma({path:p.relativePath,caseSensitive:p.caseSensitive,end:m},b),y=p.route;if(!w&&m&&i&&!a[a.length-1].route.index&&(w=Ma({path:p.relativePath,caseSensitive:p.caseSensitive,end:!1},b)),!w)return null;Object.assign(s,w.params),d.push({params:s,pathname:it([c,w.pathname]),pathnameBase:o0(it([c,w.pathnameBase])),route:y}),w.pathnameBase!=="/"&&(c=it([c,w.pathnameBase]))}return d}function Ma(t,r){typeof t=="string"&&(t={path:t,caseSensitive:!1,end:!0});let[i,a]=Zv(t.path,t.caseSensitive,t.end),s=r.match(i);if(!s)return null;let c=s[0],d=c.replace(/(.)\/+$/,"$1"),h=s.slice(1);return{params:a.reduce((m,{paramName:b,isOptional:w},y)=>{if(b==="*"){let x=h[y]||"";d=c.slice(0,c.length-x.length).replace(/(.)\/+$/,"$1")}const E=h[y];return w&&!E?m[b]=void 0:m[b]=(E||"").replace(/%2F/g,"/"),m},{}),pathname:c,pathnameBase:d,pattern:t}}function Zv(t,r=!1,i=!0){Sn(t==="*"||!t.endsWith("*")||t.endsWith("/*"),`Route path "${t}" will be treated as if it were "${t.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${t.replace(/\*$/,"/*")}".`);let a=[],s="^"+t.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(d,h,p)=>(a.push({paramName:h,isOptional:p!=null}),p?"/?([^\\/]+)?":"/([^\\/]+)"));return t.endsWith("*")?(a.push({paramName:"*"}),s+=t==="*"||t==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):i?s+="\\/*$":t!==""&&t!=="/"&&(s+="(?:(?=\\/|$))"),[new RegExp(s,r?void 0:"i"),a]}function e0(t){try{return t.split("/").map(r=>decodeURIComponent(r).replace(/\//g,"%2F")).join("/")}catch(r){return Sn(!1,`The URL path "${t}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${r}).`),t}}function jt(t,r){if(r==="/")return t;if(!t.toLowerCase().startsWith(r.toLowerCase()))return null;let i=r.endsWith("/")?r.length-1:r.length,a=t.charAt(i);return a&&a!=="/"?null:t.slice(i)||"/"}function n0(t,r="/"){let{pathname:i,search:a="",hash:s=""}=typeof t=="string"?ir(t):t;return{pathname:i?i.startsWith("/")?i:t0(i,r):r,search:i0(a),hash:a0(s)}}function t0(t,r){let i=r.replace(/\/+$/,"").split("/");return t.split("/").forEach(s=>{s===".."?i.length>1&&i.pop():s!=="."&&i.push(s)}),i.length>1?i.join("/"):"/"}function lu(t,r,i,a){return`Cannot include a '${t}' character in a manually specified \`to.${r}\` field [${JSON.stringify(a)}].  Please separate it out to the \`to.${i}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function r0(t){return t.filter((r,i)=>i===0||r.route.path&&r.route.path.length>0)}function ec(t){let r=r0(t);return r.map((i,a)=>a===r.length-1?i.pathname:i.pathnameBase)}function nc(t,r,i,a=!1){let s;typeof t=="string"?s=ir(t):(s={...t},De(!s.pathname||!s.pathname.includes("?"),lu("?","pathname","search",s)),De(!s.pathname||!s.pathname.includes("#"),lu("#","pathname","hash",s)),De(!s.search||!s.search.includes("#"),lu("#","search","hash",s)));let c=t===""||s.pathname==="",d=c?"/":s.pathname,h;if(d==null)h=i;else{let w=r.length-1;if(!a&&d.startsWith("..")){let y=d.split("/");for(;y[0]==="..";)y.shift(),w-=1;s.pathname=y.join("/")}h=w>=0?r[w]:"/"}let p=n0(s,h),m=d&&d!=="/"&&d.endsWith("/"),b=(c||d===".")&&i.endsWith("/");return!p.pathname.endsWith("/")&&(m||b)&&(p.pathname+="/"),p}var it=t=>t.join("/").replace(/\/\/+/g,"/"),o0=t=>t.replace(/\/+$/,"").replace(/^\/*/,"/"),i0=t=>!t||t==="?"?"":t.startsWith("?")?t:"?"+t,a0=t=>!t||t==="#"?"":t.startsWith("#")?t:"#"+t;function l0(t){return t!=null&&typeof t.status=="number"&&typeof t.statusText=="string"&&typeof t.internal=="boolean"&&"data"in t}var tm=["POST","PUT","PATCH","DELETE"];new Set(tm);var s0=["GET",...tm];new Set(s0);var qr=S.createContext(null);qr.displayName="DataRouter";var Ya=S.createContext(null);Ya.displayName="DataRouterState";var rm=S.createContext({isTransitioning:!1});rm.displayName="ViewTransition";var u0=S.createContext(new Map);u0.displayName="Fetchers";var c0=S.createContext(null);c0.displayName="Await";var Ln=S.createContext(null);Ln.displayName="Navigation";var ni=S.createContext(null);ni.displayName="Location";var Qn=S.createContext({outlet:null,matches:[],isDataRoute:!1});Qn.displayName="Route";var tc=S.createContext(null);tc.displayName="RouteError";function f0(t,{relative:r}={}){De(Ur(),"useHref() may be used only in the context of a <Router> component.");let{basename:i,navigator:a}=S.useContext(Ln),{hash:s,pathname:c,search:d}=ti(t,{relative:r}),h=c;return i!=="/"&&(h=c==="/"?i:it([i,c])),a.createHref({pathname:h,search:d,hash:s})}function Ur(){return S.useContext(ni)!=null}function At(){return De(Ur(),"useLocation() may be used only in the context of a <Router> component."),S.useContext(ni).location}var om="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function im(t){S.useContext(Ln).static||S.useLayoutEffect(t)}function am(){let{isDataRoute:t}=S.useContext(Qn);return t?E0():d0()}function d0(){De(Ur(),"useNavigate() may be used only in the context of a <Router> component.");let t=S.useContext(qr),{basename:r,navigator:i}=S.useContext(Ln),{matches:a}=S.useContext(Qn),{pathname:s}=At(),c=JSON.stringify(ec(a)),d=S.useRef(!1);return im(()=>{d.current=!0}),S.useCallback((p,m={})=>{if(Sn(d.current,om),!d.current)return;if(typeof p=="number"){i.go(p);return}let b=nc(p,JSON.parse(c),s,m.relative==="path");t==null&&r!=="/"&&(b.pathname=b.pathname==="/"?r:it([r,b.pathname])),(m.replace?i.replace:i.push)(b,m.state,m)},[r,i,c,s,t])}S.createContext(null);function ti(t,{relative:r}={}){let{matches:i}=S.useContext(Qn),{pathname:a}=At(),s=JSON.stringify(ec(i));return S.useMemo(()=>nc(t,JSON.parse(s),a,r==="path"),[t,s,a,r])}function p0(t,r){return lm(t,r)}function lm(t,r,i,a){var _;De(Ur(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:s}=S.useContext(Ln),{matches:c}=S.useContext(Qn),d=c[c.length-1],h=d?d.params:{},p=d?d.pathname:"/",m=d?d.pathnameBase:"/",b=d&&d.route;{let C=b&&b.path||"";sm(p,!b||C.endsWith("*")||C.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${p}" (under <Route path="${C}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${C}"> to <Route path="${C==="/"?"*":`${C}/*`}">.`)}let w=At(),y;if(r){let C=typeof r=="string"?ir(r):r;De(m==="/"||((_=C.pathname)==null?void 0:_.startsWith(m)),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${m}" but pathname "${C.pathname}" was given in the \`location\` prop.`),y=C}else y=w;let E=y.pathname||"/",x=E;if(m!=="/"){let C=m.replace(/^\//,"").split("/");x="/"+E.replace(/^\//,"").split("/").slice(C.length).join("/")}let v=Zh(t,{pathname:x});Sn(b||v!=null,`No routes matched location "${y.pathname}${y.search}${y.hash}" `),Sn(v==null||v[v.length-1].route.element!==void 0||v[v.length-1].route.Component!==void 0||v[v.length-1].route.lazy!==void 0,`Matched leaf route at location "${y.pathname}${y.search}${y.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let k=v0(v&&v.map(C=>Object.assign({},C,{params:Object.assign({},h,C.params),pathname:it([m,s.encodeLocation?s.encodeLocation(C.pathname).pathname:C.pathname]),pathnameBase:C.pathnameBase==="/"?m:it([m,s.encodeLocation?s.encodeLocation(C.pathnameBase).pathname:C.pathnameBase])})),c,i,a);return r&&k?S.createElement(ni.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...y},navigationType:"POP"}},k):k}function h0(){let t=S0(),r=l0(t)?`${t.status} ${t.statusText}`:t instanceof Error?t.message:JSON.stringify(t),i=t instanceof Error?t.stack:null,a="rgba(200,200,200, 0.5)",s={padding:"0.5rem",backgroundColor:a},c={padding:"2px 4px",backgroundColor:a},d=null;return console.error("Error handled by React Router default ErrorBoundary:",t),d=S.createElement(S.Fragment,null,S.createElement("p",null,"💿 Hey developer 👋"),S.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",S.createElement("code",{style:c},"ErrorBoundary")," or"," ",S.createElement("code",{style:c},"errorElement")," prop on your route.")),S.createElement(S.Fragment,null,S.createElement("h2",null,"Unexpected Application Error!"),S.createElement("h3",{style:{fontStyle:"italic"}},r),i?S.createElement("pre",{style:s},i):null,d)}var m0=S.createElement(h0,null),g0=class extends S.Component{constructor(t){super(t),this.state={location:t.location,revalidation:t.revalidation,error:t.error}}static getDerivedStateFromError(t){return{error:t}}static getDerivedStateFromProps(t,r){return r.location!==t.location||r.revalidation!=="idle"&&t.revalidation==="idle"?{error:t.error,location:t.location,revalidation:t.revalidation}:{error:t.error!==void 0?t.error:r.error,location:r.location,revalidation:t.revalidation||r.revalidation}}componentDidCatch(t,r){console.error("React Router caught the following error during render",t,r)}render(){return this.state.error!==void 0?S.createElement(Qn.Provider,{value:this.props.routeContext},S.createElement(tc.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function y0({routeContext:t,match:r,children:i}){let a=S.useContext(qr);return a&&a.static&&a.staticContext&&(r.route.errorElement||r.route.ErrorBoundary)&&(a.staticContext._deepestRenderedBoundaryId=r.route.id),S.createElement(Qn.Provider,{value:t},i)}function v0(t,r=[],i=null,a=null){if(t==null){if(!i)return null;if(i.errors)t=i.matches;else if(r.length===0&&!i.initialized&&i.matches.length>0)t=i.matches;else return null}let s=t,c=i==null?void 0:i.errors;if(c!=null){let p=s.findIndex(m=>m.route.id&&(c==null?void 0:c[m.route.id])!==void 0);De(p>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(c).join(",")}`),s=s.slice(0,Math.min(s.length,p+1))}let d=!1,h=-1;if(i)for(let p=0;p<s.length;p++){let m=s[p];if((m.route.HydrateFallback||m.route.hydrateFallbackElement)&&(h=p),m.route.id){let{loaderData:b,errors:w}=i,y=m.route.loader&&!b.hasOwnProperty(m.route.id)&&(!w||w[m.route.id]===void 0);if(m.route.lazy||y){d=!0,h>=0?s=s.slice(0,h+1):s=[s[0]];break}}}return s.reduceRight((p,m,b)=>{let w,y=!1,E=null,x=null;i&&(w=c&&m.route.id?c[m.route.id]:void 0,E=m.route.errorElement||m0,d&&(h<0&&b===0?(sm("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),y=!0,x=null):h===b&&(y=!0,x=m.route.hydrateFallbackElement||null)));let v=r.concat(s.slice(0,b+1)),k=()=>{let _;return w?_=E:y?_=x:m.route.Component?_=S.createElement(m.route.Component,null):m.route.element?_=m.route.element:_=p,S.createElement(y0,{match:m,routeContext:{outlet:p,matches:v,isDataRoute:i!=null},children:_})};return i&&(m.route.ErrorBoundary||m.route.errorElement||b===0)?S.createElement(g0,{location:i.location,revalidation:i.revalidation,component:E,error:w,children:k(),routeContext:{outlet:null,matches:v,isDataRoute:!0}}):k()},null)}function rc(t){return`${t} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function b0(t){let r=S.useContext(qr);return De(r,rc(t)),r}function x0(t){let r=S.useContext(Ya);return De(r,rc(t)),r}function w0(t){let r=S.useContext(Qn);return De(r,rc(t)),r}function oc(t){let r=w0(t),i=r.matches[r.matches.length-1];return De(i.route.id,`${t} can only be used on routes that contain a unique "id"`),i.route.id}function k0(){return oc("useRouteId")}function S0(){var a;let t=S.useContext(tc),r=x0("useRouteError"),i=oc("useRouteError");return t!==void 0?t:(a=r.errors)==null?void 0:a[i]}function E0(){let{router:t}=b0("useNavigate"),r=oc("useNavigate"),i=S.useRef(!1);return im(()=>{i.current=!0}),S.useCallback(async(s,c={})=>{Sn(i.current,om),i.current&&(typeof s=="number"?t.navigate(s):await t.navigate(s,{fromRouteId:r,...c}))},[t,r])}var qp={};function sm(t,r,i){!r&&!qp[t]&&(qp[t]=!0,Sn(!1,i))}S.memo(O0);function O0({routes:t,future:r,state:i}){return lm(t,void 0,i,r)}function Up({to:t,replace:r,state:i,relative:a}){De(Ur(),"<Navigate> may be used only in the context of a <Router> component.");let{static:s}=S.useContext(Ln);Sn(!s,"<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");let{matches:c}=S.useContext(Qn),{pathname:d}=At(),h=am(),p=nc(t,ec(c),d,a==="path"),m=JSON.stringify(p);return S.useEffect(()=>{h(JSON.parse(m),{replace:r,state:i,relative:a})},[h,m,a,r,i]),null}function Mu(t){De(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function C0({basename:t="/",children:r=null,location:i,navigationType:a="POP",navigator:s,static:c=!1}){De(!Ur(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let d=t.replace(/^\/*/,"/"),h=S.useMemo(()=>({basename:d,navigator:s,static:c,future:{}}),[d,s,c]);typeof i=="string"&&(i=ir(i));let{pathname:p="/",search:m="",hash:b="",state:w=null,key:y="default"}=i,E=S.useMemo(()=>{let x=jt(p,d);return x==null?null:{location:{pathname:x,search:m,hash:b,state:w,key:y},navigationType:a}},[d,p,m,b,w,y,a]);return Sn(E!=null,`<Router basename="${d}"> is not able to match the URL "${p}${m}${b}" because it does not start with the basename, so the <Router> won't render anything.`),E==null?null:S.createElement(Ln.Provider,{value:h},S.createElement(ni.Provider,{children:r,value:E}))}function P0({children:t,location:r}){return p0(ju(t),r)}function ju(t,r=[]){let i=[];return S.Children.forEach(t,(a,s)=>{if(!S.isValidElement(a))return;let c=[...r,s];if(a.type===S.Fragment){i.push.apply(i,ju(a.props.children,c));return}De(a.type===Mu,`[${typeof a.type=="string"?a.type:a.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),De(!a.props.index||!a.props.children,"An index route cannot have child routes.");let d={id:a.props.id||c.join("-"),caseSensitive:a.props.caseSensitive,element:a.props.element,Component:a.props.Component,index:a.props.index,path:a.props.path,loader:a.props.loader,action:a.props.action,hydrateFallbackElement:a.props.hydrateFallbackElement,HydrateFallback:a.props.HydrateFallback,errorElement:a.props.errorElement,ErrorBoundary:a.props.ErrorBoundary,hasErrorBoundary:a.props.hasErrorBoundary===!0||a.props.ErrorBoundary!=null||a.props.errorElement!=null,shouldRevalidate:a.props.shouldRevalidate,handle:a.props.handle,lazy:a.props.lazy};a.props.children&&(d.children=ju(a.props.children,c)),i.push(d)}),i}var _a="get",Ra="application/x-www-form-urlencoded";function Ga(t){return t!=null&&typeof t.tagName=="string"}function _0(t){return Ga(t)&&t.tagName.toLowerCase()==="button"}function R0(t){return Ga(t)&&t.tagName.toLowerCase()==="form"}function T0(t){return Ga(t)&&t.tagName.toLowerCase()==="input"}function N0(t){return!!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)}function z0(t,r){return t.button===0&&(!r||r==="_self")&&!N0(t)}var ya=null;function D0(){if(ya===null)try{new FormData(document.createElement("form"),0),ya=!1}catch{ya=!0}return ya}var M0=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function su(t){return t!=null&&!M0.has(t)?(Sn(!1,`"${t}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Ra}"`),null):t}function j0(t,r){let i,a,s,c,d;if(R0(t)){let h=t.getAttribute("action");a=h?jt(h,r):null,i=t.getAttribute("method")||_a,s=su(t.getAttribute("enctype"))||Ra,c=new FormData(t)}else if(_0(t)||T0(t)&&(t.type==="submit"||t.type==="image")){let h=t.form;if(h==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let p=t.getAttribute("formaction")||h.getAttribute("action");if(a=p?jt(p,r):null,i=t.getAttribute("formmethod")||h.getAttribute("method")||_a,s=su(t.getAttribute("formenctype"))||su(h.getAttribute("enctype"))||Ra,c=new FormData(h,t),!D0()){let{name:m,type:b,value:w}=t;if(b==="image"){let y=m?`${m}.`:"";c.append(`${y}x`,"0"),c.append(`${y}y`,"0")}else m&&c.append(m,w)}}else{if(Ga(t))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');i=_a,a=null,s=Ra,d=t}return c&&s==="text/plain"&&(d=c,c=void 0),{action:a,method:i.toLowerCase(),encType:s,formData:c,body:d}}function ic(t,r){if(t===!1||t===null||typeof t>"u")throw new Error(r)}async function I0(t,r){if(t.id in r)return r[t.id];try{let i=await import(t.module);return r[t.id]=i,i}catch(i){return console.error(`Error loading route module \`${t.module}\`, reloading page...`),console.error(i),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function L0(t){return t==null?!1:t.href==null?t.rel==="preload"&&typeof t.imageSrcSet=="string"&&typeof t.imageSizes=="string":typeof t.rel=="string"&&typeof t.href=="string"}async function A0(t,r,i){let a=await Promise.all(t.map(async s=>{let c=r.routes[s.route.id];if(c){let d=await I0(c,i);return d.links?d.links():[]}return[]}));return U0(a.flat(1).filter(L0).filter(s=>s.rel==="stylesheet"||s.rel==="preload").map(s=>s.rel==="stylesheet"?{...s,rel:"prefetch",as:"style"}:{...s,rel:"prefetch"}))}function Bp(t,r,i,a,s,c){let d=(p,m)=>i[m]?p.route.id!==i[m].route.id:!0,h=(p,m)=>{var b;return i[m].pathname!==p.pathname||((b=i[m].route.path)==null?void 0:b.endsWith("*"))&&i[m].params["*"]!==p.params["*"]};return c==="assets"?r.filter((p,m)=>d(p,m)||h(p,m)):c==="data"?r.filter((p,m)=>{var w;let b=a.routes[p.route.id];if(!b||!b.hasLoader)return!1;if(d(p,m)||h(p,m))return!0;if(p.route.shouldRevalidate){let y=p.route.shouldRevalidate({currentUrl:new URL(s.pathname+s.search+s.hash,window.origin),currentParams:((w=i[0])==null?void 0:w.params)||{},nextUrl:new URL(t,window.origin),nextParams:p.params,defaultShouldRevalidate:!0});if(typeof y=="boolean")return y}return!0}):[]}function F0(t,r){return $0(t.map(i=>{let a=r.routes[i.route.id];if(!a)return[];let s=[a.module];return a.imports&&(s=s.concat(a.imports)),s}).flat(1))}function $0(t){return[...new Set(t)]}function q0(t){let r={},i=Object.keys(t).sort();for(let a of i)r[a]=t[a];return r}function U0(t,r){let i=new Set;return new Set(r),t.reduce((a,s)=>{let c=JSON.stringify(q0(s));return i.has(c)||(i.add(c),a.push({key:c,link:s})),a},[])}function B0(t){let r=typeof t=="string"?new URL(t,typeof window>"u"?"server://singlefetch/":window.location.origin):t;return r.pathname==="/"?r.pathname="_root.data":r.pathname=`${r.pathname.replace(/\/$/,"")}.data`,r}function H0(){let t=S.useContext(qr);return ic(t,"You must render this element inside a <DataRouterContext.Provider> element"),t}function W0(){let t=S.useContext(Ya);return ic(t,"You must render this element inside a <DataRouterStateContext.Provider> element"),t}var ac=S.createContext(void 0);ac.displayName="FrameworkContext";function um(){let t=S.useContext(ac);return ic(t,"You must render this element inside a <HydratedRouter> element"),t}function Q0(t,r){let i=S.useContext(ac),[a,s]=S.useState(!1),[c,d]=S.useState(!1),{onFocus:h,onBlur:p,onMouseEnter:m,onMouseLeave:b,onTouchStart:w}=r,y=S.useRef(null);S.useEffect(()=>{if(t==="render"&&d(!0),t==="viewport"){let v=_=>{_.forEach(C=>{d(C.isIntersecting)})},k=new IntersectionObserver(v,{threshold:.5});return y.current&&k.observe(y.current),()=>{k.disconnect()}}},[t]),S.useEffect(()=>{if(a){let v=setTimeout(()=>{d(!0)},100);return()=>{clearTimeout(v)}}},[a]);let E=()=>{s(!0)},x=()=>{s(!1),d(!1)};return i?t!=="intent"?[c,y,{}]:[c,y,{onFocus:Mo(h,E),onBlur:Mo(p,x),onMouseEnter:Mo(m,E),onMouseLeave:Mo(b,x),onTouchStart:Mo(w,E)}]:[!1,y,{}]}function Mo(t,r){return i=>{t&&t(i),i.defaultPrevented||r(i)}}function V0({page:t,...r}){let{router:i}=H0(),a=S.useMemo(()=>Zh(i.routes,t,i.basename),[i.routes,t,i.basename]);return a?S.createElement(X0,{page:t,matches:a,...r}):null}function K0(t){let{manifest:r,routeModules:i}=um(),[a,s]=S.useState([]);return S.useEffect(()=>{let c=!1;return A0(t,r,i).then(d=>{c||s(d)}),()=>{c=!0}},[t,r,i]),a}function X0({page:t,matches:r,...i}){let a=At(),{manifest:s,routeModules:c}=um(),{loaderData:d,matches:h}=W0(),p=S.useMemo(()=>Bp(t,r,h,s,a,"data"),[t,r,h,s,a]),m=S.useMemo(()=>Bp(t,r,h,s,a,"assets"),[t,r,h,s,a]),b=S.useMemo(()=>{if(t===a.pathname+a.search+a.hash)return[];let E=new Set,x=!1;if(r.forEach(k=>{var C;let _=s.routes[k.route.id];!_||!_.hasLoader||(!p.some(O=>O.route.id===k.route.id)&&k.route.id in d&&((C=c[k.route.id])!=null&&C.shouldRevalidate)||_.hasClientLoader?x=!0:E.add(k.route.id))}),E.size===0)return[];let v=B0(t);return x&&E.size>0&&v.searchParams.set("_routes",r.filter(k=>E.has(k.route.id)).map(k=>k.route.id).join(",")),[v.pathname+v.search]},[d,a,s,p,r,t,c]),w=S.useMemo(()=>F0(m,s),[m,s]),y=K0(m);return S.createElement(S.Fragment,null,b.map(E=>S.createElement("link",{key:E,rel:"prefetch",as:"fetch",href:E,...i})),w.map(E=>S.createElement("link",{key:E,rel:"modulepreload",href:E,...i})),y.map(({key:E,link:x})=>S.createElement("link",{key:E,...x})))}function Y0(...t){return r=>{t.forEach(i=>{typeof i=="function"?i(r):i!=null&&(i.current=r)})}}var cm=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{cm&&(window.__reactRouterVersion="7.1.3")}catch{}function G0({basename:t,children:r,window:i}){let a=S.useRef();a.current==null&&(a.current=Fv({window:i,v5Compat:!0}));let s=a.current,[c,d]=S.useState({action:s.action,location:s.location}),h=S.useCallback(p=>{S.startTransition(()=>d(p))},[d]);return S.useLayoutEffect(()=>s.listen(h),[s,h]),S.createElement(C0,{basename:t,children:r,location:c.location,navigationType:c.action,navigator:s})}var fm=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,dm=S.forwardRef(function({onClick:r,discover:i="render",prefetch:a="none",relative:s,reloadDocument:c,replace:d,state:h,target:p,to:m,preventScrollReset:b,viewTransition:w,...y},E){let{basename:x}=S.useContext(Ln),v=typeof m=="string"&&fm.test(m),k,_=!1;if(typeof m=="string"&&v&&(k=m,cm))try{let A=new URL(window.location.href),$=m.startsWith("//")?new URL(A.protocol+m):new URL(m),W=jt($.pathname,x);$.origin===A.origin&&W!=null?m=W+$.search+$.hash:_=!0}catch{Sn(!1,`<Link to="${m}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let C=f0(m,{relative:s}),[O,P,D]=Q0(a,y),N=n1(m,{replace:d,state:h,target:p,preventScrollReset:b,relative:s,viewTransition:w});function T(A){r&&r(A),A.defaultPrevented||N(A)}let I=S.createElement("a",{...y,...D,href:k||C,onClick:_||c?r:T,ref:Y0(E,P),target:p,"data-discover":!v&&i==="render"?"true":void 0});return O&&!v?S.createElement(S.Fragment,null,I,S.createElement(V0,{page:C})):I});dm.displayName="Link";var J0=S.forwardRef(function({"aria-current":r="page",caseSensitive:i=!1,className:a="",end:s=!1,style:c,to:d,viewTransition:h,children:p,...m},b){let w=ti(d,{relative:m.relative}),y=At(),E=S.useContext(Ya),{navigator:x,basename:v}=S.useContext(Ln),k=E!=null&&a1(w)&&h===!0,_=x.encodeLocation?x.encodeLocation(w).pathname:w.pathname,C=y.pathname,O=E&&E.navigation&&E.navigation.location?E.navigation.location.pathname:null;i||(C=C.toLowerCase(),O=O?O.toLowerCase():null,_=_.toLowerCase()),O&&v&&(O=jt(O,v)||O);const P=_!=="/"&&_.endsWith("/")?_.length-1:_.length;let D=C===_||!s&&C.startsWith(_)&&C.charAt(P)==="/",N=O!=null&&(O===_||!s&&O.startsWith(_)&&O.charAt(_.length)==="/"),T={isActive:D,isPending:N,isTransitioning:k},I=D?r:void 0,A;typeof a=="function"?A=a(T):A=[a,D?"active":null,N?"pending":null,k?"transitioning":null].filter(Boolean).join(" ");let $=typeof c=="function"?c(T):c;return S.createElement(dm,{...m,"aria-current":I,className:A,ref:b,style:$,to:d,viewTransition:h},typeof p=="function"?p(T):p)});J0.displayName="NavLink";var Z0=S.forwardRef(({discover:t="render",fetcherKey:r,navigate:i,reloadDocument:a,replace:s,state:c,method:d=_a,action:h,onSubmit:p,relative:m,preventScrollReset:b,viewTransition:w,...y},E)=>{let x=o1(),v=i1(h,{relative:m}),k=d.toLowerCase()==="get"?"get":"post",_=typeof h=="string"&&fm.test(h),C=O=>{if(p&&p(O),O.defaultPrevented)return;O.preventDefault();let P=O.nativeEvent.submitter,D=(P==null?void 0:P.getAttribute("formmethod"))||d;x(P||O.currentTarget,{fetcherKey:r,method:D,navigate:i,replace:s,state:c,relative:m,preventScrollReset:b,viewTransition:w})};return S.createElement("form",{ref:E,method:k,action:v,onSubmit:a?p:C,...y,"data-discover":!_&&t==="render"?"true":void 0})});Z0.displayName="Form";function e1(t){return`${t} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function pm(t){let r=S.useContext(qr);return De(r,e1(t)),r}function n1(t,{target:r,replace:i,state:a,preventScrollReset:s,relative:c,viewTransition:d}={}){let h=am(),p=At(),m=ti(t,{relative:c});return S.useCallback(b=>{if(z0(b,r)){b.preventDefault();let w=i!==void 0?i:Qo(p)===Qo(m);h(t,{replace:w,state:a,preventScrollReset:s,relative:c,viewTransition:d})}},[p,h,m,i,a,r,t,s,c,d])}var t1=0,r1=()=>`__${String(++t1)}__`;function o1(){let{router:t}=pm("useSubmit"),{basename:r}=S.useContext(Ln),i=k0();return S.useCallback(async(a,s={})=>{let{action:c,method:d,encType:h,formData:p,body:m}=j0(a,r);if(s.navigate===!1){let b=s.fetcherKey||r1();await t.fetch(b,i,s.action||c,{preventScrollReset:s.preventScrollReset,formData:p,body:m,formMethod:s.method||d,formEncType:s.encType||h,flushSync:s.flushSync})}else await t.navigate(s.action||c,{preventScrollReset:s.preventScrollReset,formData:p,body:m,formMethod:s.method||d,formEncType:s.encType||h,replace:s.replace,state:s.state,fromRouteId:i,flushSync:s.flushSync,viewTransition:s.viewTransition})},[t,r,i])}function i1(t,{relative:r}={}){let{basename:i}=S.useContext(Ln),a=S.useContext(Qn);De(a,"useFormAction must be used inside a RouteContext");let[s]=a.matches.slice(-1),c={...ti(t||".",{relative:r})},d=At();if(t==null){c.search=d.search;let h=new URLSearchParams(c.search),p=h.getAll("index");if(p.some(b=>b==="")){h.delete("index"),p.filter(w=>w).forEach(w=>h.append("index",w));let b=h.toString();c.search=b?`?${b}`:""}}return(!t||t===".")&&s.route.index&&(c.search=c.search?c.search.replace(/^\?/,"?index&"):"?index"),i!=="/"&&(c.pathname=c.pathname==="/"?i:it([i,c.pathname])),Qo(c)}function a1(t,r={}){let i=S.useContext(rm);De(i!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:a}=pm("useViewTransitionState"),s=ti(t,{relative:r.relative});if(!i.isTransitioning)return!1;let c=jt(i.currentLocation.pathname,a)||i.currentLocation.pathname,d=jt(i.nextLocation.pathname,a)||i.nextLocation.pathname;return Ma(s.pathname,d)!=null||Ma(s.pathname,c)!=null}new TextEncoder;var l1=Jh();const Ar=ei(l1);var uu={exports:{}},cu={};/**
 * @license React
...
}`);Array.from({length:4},function(t,r){return"--life-line-phase".concat(r+1,"-color")});const MS=()=>U.jsx("center",{style:{paddingTop:"30vh"},children:U.jsx(DS,{color:"#491d90",size:"large"})}),jS=iS(jc);Lv.createRoot(document.getElementById("root")).render(U.jsx(S.StrictMode,{children:U.jsx(w1,{store:jc,children:U.jsx(Rg,{loading:U.jsx(MS,{}),persistor:jS,children:U.jsx(Dk,{})})})}));
